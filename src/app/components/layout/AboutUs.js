  ...
  return (
    <section className="text-center my-16" id="about">
      ...
      <div className="text-gray-500 max-w-2xl mx-auto mt-4 flex flex-col gap-4">
        <p>
          Welcome to Mealtime! At Mealtime, we are passionate about making your
          ...
          favorite local restaurants, right at your fingertips. Whether you are
        ...
        <p>
          ...
          only Mealtime can offer. We are here to make every meal a memorable
